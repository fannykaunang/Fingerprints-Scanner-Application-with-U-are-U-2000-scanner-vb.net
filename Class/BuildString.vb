...
Public Class BuildString
    ...
    'Public Event EnabledOK(ByVal Result As Boolean)
    ...
    'Public Sub BuildEnabled(ByVal b As IntPtr)
    '    If b <> 0 Then
    '        'build temp array
    ...
    '        RaiseEvent EnabledOK(s)
    '        ReDim tempA(-1)
    '    End If
    'End Sub

    'Public Sub PostEnabled(ByVal hwnd As Integer, ByVal wMsg As Integer, ByVal wParam As Integer, ByVal lParam As Boolean)
    '    Me.hwnd = hwnd
    '    Me.wMsg = wMsg
    '    Me.wParam = wParam
    '    Me.lParam = lParam
    ...
    '    t = New Threading.Thread(AddressOf SendEnabled)
    '    t.Start()
    'End Sub
